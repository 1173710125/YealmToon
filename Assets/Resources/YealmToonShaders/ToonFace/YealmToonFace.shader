Shader "YealmToon/Face"
{
    Properties
    {
        ...
        [Header(skin only)]
        [NoScaleOffset] _RampSSSMap("RampSSSMap", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LitPassVertexFace
            #pragma fragment LitPassFragmentFace
            ...
            // defines
            #define ToonFaceLighting
            
            
            // input; m66-2 library; pass
            #include "ToonFaceLitInput.hlsl"
            #include "ToonFaceLitForwardPass.hlsl"
        ...
        Pass
        {
            ...
            // Includes
            #include "ToonFaceLitInput.hlsl"
            #include "ToonFaceLitShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "ToonFaceLitInput.hlsl"
            #include "ToonFaceLitDepthPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "ToonFaceLitInput.hlsl"
            #include "ToonFaceLitMaterialPass.hlsl"
            ENDHLSL
        }
    }
